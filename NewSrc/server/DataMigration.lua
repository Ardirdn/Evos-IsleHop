...
local CONFIG = {
    FirebaseProjectId = "mounthikers-985ea",
    MountainName = "Nirwana",
    Debug = false,
    SkipFirebase = false,
}
...
local LegacyPlaytimeStore = DataStoreService:GetOrderedDataStore("TopTimePlayed")
local LegacyWingsStore = DataStoreService:GetDataStore("FlyTogetherWingsStatus_V2")
local LegacyCrystalAuraStore = DataStoreService:GetDataStore("AuraExchangeData_V2")

local PLAYTIME_STAT_PREFIX = "TimePlayed"
